...
int start_s=clock();
    ...
    // create plans
    plan_f = fftw_plan_dft_1d( height*width, data_in, fft,  FFTW_FORWARD,  FFTW_ESTIMATE );
...
//reusing plan f
plan_f = fftw_plan_dft_1d( height*width, gg, transfer,FFTW_FORWARD, FFTW_ESTIMATE);
...
//reusing plan f
plan_f = fftw_plan_dft_1d( height*width, products,inverse,FFTW_BACKWARD, FFTW_ESTIMATE);
